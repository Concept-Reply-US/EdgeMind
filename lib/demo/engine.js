...
class ScenarioRunner {
  ...
  _executeStep(step, index) {
    ...
    const interval = setInterval(() => {
      ...
      // Publish to MQTT with concept-reply namespace
  ...
  stop() {
    ...
    console.log(`[DEMO ENGINE] Stopping scenario: ${this.currentScenario.name}`);
...
class InjectionManager {
  ...
  start({ equipment, anomalyType, severity, durationMs }) {
    ...
    const topicMap = {
      'filler': `${CONFIG.demo.namespace}/Enterprise B/Site1/fillerproduction/fillingline01/filler/processdata/${anomalyType}/level`,
      'vat01': `${CONFIG.demo.namespace}/Enterprise B/Site1/liquidprocessing/mixroom01/vat01/processdata/process/${anomalyType}`,
      'caploader': `${CONFIG.demo.namespace}/Enterprise B/Site1/fillerproduction/fillingline01/caploader/processdata/${anomalyType}/actual`,
      'washer': `${CONFIG.demo.namespace}/Enterprise B/Site1/fillerproduction/fillingline01/washer/processdata/${anomalyType}/level`
    };
