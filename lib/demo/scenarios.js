...
const DEMO_SCENARIOS = [
  {
    ...
    steps: [
      {
        delayMs: 0,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/filler/processdata/vibration/level`,
        generator: 'ramp',
        params: { startValue: 2.1, endValue: 8.4, durationMs: 180000, intervalMs: 5000, noise: 0.2 }
      },
      {
        delayMs: 60000,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/filler/metric/input/rateactual`,
        generator: 'ramp',
  ...
  },
  {
    ...
    steps: [
      {
        delayMs: 0,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/liquidprocessing/mixroom01/vat01/processdata/process/temperature`,
        generator: 'ramp',
  ...
  },
  {
    ...
    steps: [
      {
        delayMs: 0,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/caploader/processdata/torque/actual`,
        generator: 'ramp',
        params: { startValue: 18, endValue: 28, durationMs: 200000, intervalMs: 5000, noise: 1.5 }
      },
      {
        delayMs: 0,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/caploader/processdata/torque/variance`,
        generator: 'ramp',
  ...
  },
  {
    ...
    steps: [
      {
        delayMs: 0,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/washer/metric/oee`,
        generator: 'ramp',
        params: { startValue: 98, endValue: 72, durationMs: 240000, intervalMs: 5000, noise: 1.5 }
      },
      {
        delayMs: 60000,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/filler/metric/oee`,
        generator: 'ramp',
        params: { startValue: 87.8, endValue: 75, durationMs: 180000, intervalMs: 5000, noise: 1.0 }
      },
      {
        delayMs: 120000,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/caploader/metric/oee`,
        generator: 'ramp',
  ...
  },
  {
    ...
    steps: [
      {
        delayMs: 0,
        topic: `${DEMO_NAMESPACE}/Enterprise B/Site1/fillerproduction/fillingline01/filler/metric/defectrate`,
        generator: 'ramp',
