...
/**
 * Initialize the CESMII handler.
 * Loads all profiles and stores runtime dependencies.
 * @param {Object} params
 * @param {Object} params.writeApi - InfluxDB write API
...
/**
 * Handle a CESMII SM Profile MQTT message.
 * Validates, stores, writes to InfluxDB, and broadcasts via WebSocket.
 *
 * @param {string} topic - MQTT topic
 * @param {Object} parsed - Already-parsed JSON payload
 * @param {Object} options
 * @param {boolean} options.isInjected - Whether this is demo-injected data
 * @returns {boolean} true if handled as CESMII, false if not CESMII
 */
...
/**
 * Write a CESMII work order to InfluxDB.
 * @param {Object} workOrder - Processed work order record
 * @returns {Point} InfluxDB Point
 */
