...
async function calculateDowntimePareto(enterprise = 'ALL', window = 'daily', limit = 10) {
  ...
  // Use suffix matching to find actual state measurements (CHR01_STATE, SUM500_STATUS)
  // without matching Status_Temperature or other sensor readings with "status" prefix
