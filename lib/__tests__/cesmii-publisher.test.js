...
describe('CESMII Publisher', () => {
  ...
  describe('publishOEEReport', () => {
    ...
    test('uses "ALL" for missing site', () => {
      const oeeData = { oee: '80', availability: '85', performance: '90', quality: '95', tier: 'tier2' };
    ...
    test('updates stats counters on publish', () => {
      const oeeData = { oee: '85', availability: '90', performance: '95', quality: '100', tier: 'tier1', confidence: 0.9 };
    ...
    test('handles disconnected MQTT gracefully', () => {
      ...
      const oeeData = { oee: '85', availability: '90', performance: '95', quality: '100', tier: 'tier1' };
      const success = publishOEEReport(oeeData, 'Enterprise A', 'Site1');
...
describe('CESMII Demo Publisher', () => {
  beforeEach(() => {
    ...
    mockMqttClient.connected = true;
    mockMqttClient.publish.mockClear();
    stopDemoWorkOrders(); // Ensure clean state
    jest.useFakeTimers();
  });
