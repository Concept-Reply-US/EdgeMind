...
async function discoverOEESchema() {
  try {
    ...
    // If refresh fails, use stale cache or return empty config
    console.debug('[OEE] Schema refresh failed during discovery, using cached data:', refreshError.message);
  }
