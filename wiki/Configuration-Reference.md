...
| `MQTT_USERNAME` | Yes | `proveitreadonly` | Authentication username |
...
Claude AI integration for trend analysis.
...
Computerized Maintenance Management System for work order creation.
