...
> **C4 Level 1** - The highest level of abstraction showing EdgeMind within its operating environment.

This diagram represents the "big picture" view of the system. It shows EdgeMind as a single box, surrounded by the users who interact with it and the external systems it depends on. Use this view to understand what EdgeMind does and who/what it communicates with.
...
**Next:** [[Container-Diagram]] - Zoom into EdgeMind to see its major runtime containers.
